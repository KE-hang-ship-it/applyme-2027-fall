...
const HERO_IMAGES:Record<string,string>={"uci-me":"https://www.cic.sec.tsukuba.ac.jp/content/uploads/sites/67/2023/03/MicrosoftTeams-image-4.jpg","ucsd-mae":"https://today.ucsd.edu/news_uploads/geisel-library-L.jpg"};
    ...
    {selected && <div className="overlay" onClick={()=>setSelected(null)}>
      <section className="drawer school-detail-drawer" onClick={e=>e.stopPropagation()}>
        <section className={`school-hero hero-${selected.id.split("-")[0]}`}>
          ...
          {(selected.heroImage||HERO_IMAGES[selected.id])&&<img className="hero-image" src={selected.heroImage||HERO_IMAGES[selected.id]} alt={selected.heroAlt||`${selected.school} ${t.heroAlt}`} onError={e=>{e.currentTarget.style.display="none"}}/>}
